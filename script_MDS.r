mds.cluster = read.csv("res_prueba6/prueba6.mds.csv", header=T)
...
pdf(file="prueba6.mdsplot.pdf",width=7,height=7)
plot(rev(mds.cluster$C2), rev(mds.cluster$C1), col=colors, ylab="Dimension 1", xlab="Dimension 2", pch=20)
legend("bottomright", c("BP sample", "CEU","CHB","YRI", "TSI", "JPT", "CHD", "MEX", "GIH", "ASW","LWK", "MKK"), 
